...
/**
 * Merge Sort is a sorting algorithm that works by dividing an array into two parts, sorting each part recursively,
 * and then recombining the two parts to get a sorted array. This algorithm uses the divide and conquer technique.
 *
