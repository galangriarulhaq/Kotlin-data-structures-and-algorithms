...
fun main() {
    ...
    val recursive = reverse.reverseStringRecursive("Galang")
    val iterative = reverse.reverseStringIterative("Riarulhaq")
    println(recursive)
    println(iterative)
    println(reverse.reverseStringRecursive(recursive))
    println(reverse.reverseStringRecursive(iterative))
}